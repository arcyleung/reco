...
# Read the source file and find all functions using intrinsics
def read_source(file):
    print("FOO!")



# Replace the AVX intrinsics with SSE or neon etc. 
def recombine():
    pass
...
class Level(int):
    ...
    def show(self, *args):
        ...
        print(self)
        print('\t'*((int)(self)) + ' '.join(map(str, args)))
...
if __name__ == '__main__':
    ...
    for f in tu.get_includes():
        print(f"'\t'*{f.depth}, {f.include.name}")
